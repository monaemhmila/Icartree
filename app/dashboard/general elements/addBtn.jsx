                ...
                <section className="pt-4">
                    ...
                    <div className="flex flex-wrap justify-center gap-3 px-6 py-3">
                        <div className="flex flex-wrap justify-center sm:gap-4 gap-2">
                            <BrandItem imgAlt={'tw icon'} btnData={{ itemTitle: "Twitter Handle", itemUrl: "", uniqueType: "Twitter" }} imgSrc={"/brands/twitter.svg"} />
                            <BrandItem imgAlt={'tk icon'} btnData={{ itemTitle: "Tiktok Profile", itemUrl: "", uniqueType: "TikTok Account" }} imgSrc={"/brands/tiktok.svg"} />
                            <BrandItem imgAlt={'hd icon'} btnData={{ itemTitle: "Instagram Handle", itemUrl: "", uniqueType: "Instagram" }} imgSrc={"/brands/header.svg"} />
                            <BrandItem imgAlt={'vd icon'} btnData={{ itemTitle: "Video Link", itemUrl: "", uniqueType: "Video" }} imgSrc={"/brands/video.svg"} />
                            <BrandItem imgAlt={'mx icon'} btnData={{ itemTitle: "Music Link", itemUrl: "", uniqueType: "Music" }} imgSrc={"/brands/music.svg"} />
                        </div>
                    </div>
                </section>
            </div>
