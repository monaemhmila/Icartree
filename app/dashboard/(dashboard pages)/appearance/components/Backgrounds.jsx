        ...
        <backgroundContext.Provider value={{ setIsGradient }}>
            <div className="w-full bg-white rounded-3xl my-3 flex flex-col p-6">
                <div className="grid sm:grid-cols-[repeat(auto-fill,minmax(10rem,1fr))] grid-cols-[repeat(auto-fill,minmax(8rem,1fr))] sm:gap-4 gap-2 w-full">
                    ...
                    <BackgroundCard text={"Polka"} backImg={'url("/gif/selector-polka.51162b39945eaa9c181a.gif")'} />
                    <BackgroundCard text={"Stripe"} backImg={'url("/gif/selector-stripe.19d28e1aac1e5a38452e.gif")'} />
                    <BackgroundCard text={"Waves"} backImg={'url("/gif/selector-waves.5cf0a8a65908cd433192.gif")'} />
                    <BackgroundCard text={"Zig Zag"} backImg={'url("/gif/selector-zigzag.0bfe34b10dd92cad79b9.gif")'} />
                </div>
