    ...
    return (
        <main className="bg-dark h-screen w-screen flex items-center justify-center flex-col">
            ...
            <div className="fixed z-[5] h-screen w-screen grid place-items-center mix-blend-screen opacity-20">
                <Image src={"/wp2887798-doodles-wallpaper.jpg"} className="w-full h-full object-cover filter saturate-100 brightness-50 contrast-200 try" alt="pattern" width={1000} height={600} priority={true} />
            </div>
            <Topings />
        </main>
    )
