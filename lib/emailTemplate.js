...
<tbody style="margin-top: 15px;">
  <tr class="">
<td class="">
<img alt="Lintree Logo" class="" height="155" src="/full-logo.png">
</td>
</tr>
...
<td class="">
<div class="">
<a style="background-color:#674299;border-radius:4px;color:#fff;display:inline-block;font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:normal;line-height:50px;text-align:center;text-decoration:none;width:350px;-webkit-text-size-adjust:none;" href="https://links.icart.tn/login">${name}</a>
</div>
 <br>
</td>
</tr>
                  ...
                  <tr>
                    <td valign="top">
                      <table cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                          <td>
                            <img alt="Lintree Logo" width="155" src="/full-logo.png" style="padding: 1rem" class="logo">
                          </td>
                        </tr>
                        <tr>
